      ...
      <st.Layout>
        <div className="wrap" key={detailData?.postId}>
          ...
          <st.Content>
            ...
            <st.extraContent>
              ...
              {detailData?.tradeState !== undefined && (
                <div>{detailData.tradeState === 0 ? "판매중" : detailData.tradeState === 1 ? "예약중" : "거래완료"}</div>
              )}
            </st.extraContent>
          </st.Content>
          ...
          <st.Content flexdirection="column" align="flex-start" bordertop="1px solid gray" borderbottom="1px solid gray">
            ...
            <div className="location">
              {detailData?.tradeLocation} {detailData?.specificLocation}
            </div>
            <div className="category">{timeShown}</div>
          ...
          <st.modifyBtn>
            ...
            <div>
              ...
              <span className="deletebtn" onClick={() => deleteBtn(detailData?.postId)}>
                삭제
              </span>
            </div>
          </st.modifyBtn>
        ...
        <div className="wrap">
          <st.MoreContent>
            ...
            <div className="link" onClick={() => navigation("/list")}>
              더 구경하기
            </div>
          </st.MoreContent>
